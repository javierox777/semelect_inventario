    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={[styles.gridContainer, styles.mb40]}>
          <Image source="/static/images/logo.png" style={{ height: 32 }} />
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            <Text style={[styles.overline, styles.mb1]}>De:</Text>
          ...
          <View style={styles.col6}>
            <Text style={[styles.overline, styles.mb1]}>Para:</Text>
        ...
        <Text style={[styles.overline, styles.mb1]}>Detalles</Text>
        ...
        <View style={[styles.gridContainer, styles.footer]}>
          ...
          <View style={[styles.col4, styles.alignRight]}>
            <Text style={styles.subtitle2}>¿Tienes alguna duda?</Text>
            <Text>support@tupaz.cl</Text>
          </View>
        </View>
      </Page>
    </Document>
